...
Handwavy single-task comparison; no controlled suite or measured cross-platform compatibility. Author notes poor icon handling; repository is macOS-focused. OCR portability is a design argument, not evidence of successful runs on every OS.
...
- [https://github.com/browser-use/macOS-use](https://github.com/browser-use/macOS-use) — access: `fetched`; review: `not_reviewed`.
- [https://github.com/awlevin/typesafe-computer-use](https://github.com/awlevin/typesafe-computer-use) — access: `fetched`; review: `not_reviewed`.
