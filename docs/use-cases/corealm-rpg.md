...
Illustrative author report; no controlled survival, economic or multiplayer benchmark. Planned raids/trade/economy are goals, not proven results. Recheck interval is not inference latency; media remains unreviewed.
...
- [Corealm repository](https://github.com/abcdmku/Corealm2) — discovered via [external source](https://x.com/abcdmku/status/2100743097143493062); access: `fetched`; review: `not_reviewed`.
