...
Three proposed jobs were rejected: raw grep-line ranking, review-loop pass/fail and next-tool prediction. This is an author benchmark, not independent reproduction.
