...
Not an integration running NPCs inside EVE Frontier. Reinforcement overuse, reluctance to select no target and inconsistent danger/posture judgments were reported.
