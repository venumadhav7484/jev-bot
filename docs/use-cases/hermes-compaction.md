...
- [https://github.com/TheEpTic/hermes-plugins/tree/main/hermes-jev-compact](https://github.com/TheEpTic/hermes-plugins/tree/main/hermes-jev-compact) — access: `fetch_failed`; review: `not_reviewed`.
