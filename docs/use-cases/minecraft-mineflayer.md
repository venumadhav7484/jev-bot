...
Author reports reward hacking toward wood and clarifies published shelter log came from a bugged session that would not stop hiding. Log prose is harness output, not evidence of model chain of thought. Validate executor, progress detection and recovery independently.
...
- [Hyperion](https://www.youtube.com/channel/UCD19mqbVLsb11Di1qdvhMZQ) — access: `fetched`; review: `metadata_only`.
