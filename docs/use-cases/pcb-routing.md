...
- [OpenAI pricing](https://developers.openai.com/api/docs/pricing) — access: `fetched`; review: `not_reviewed`.
- [Codex billing](https://learn.chatgpt.com/docs/pricing) — access: `fetched`; review: `not_reviewed`.
