...
The correctness guarantee belongs to the local checker, not the model's judgment.

## Sources

- Discord source — private provenance retained locally.
- [https://x.com/alexpsouthwell/status/2100543705694560657](https://x.com/alexpsouthwell/status/2100543705694560657) — access: `fetched`; review: `post_text_reviewed_media_pending`.
