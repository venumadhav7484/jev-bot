...
This is a workaround, not native generation. For Jev-bot, use a generative model for conversation and Jev for bounded decisions.

## Sources

- Discord source — private provenance retained locally.
- [https://github.com/finetuningsingh/jev-chatbot](https://github.com/finetuningsingh/jev-chatbot) — access: `fetch_failed`; review: `not_reviewed`.
